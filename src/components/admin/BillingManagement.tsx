...
export default function BillingManagement() {
  ...
  const totalRevenue = billingData.reduce((sum, item) => sum + item.amount, 0);
          ...
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {billingData.filter(item => item.status === 'pending').length}
              </p>
            </div>
          </div>
        </div>
              ...
              {billingData.map((item) => (
                <tr key={item.id}>
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <div className="text-sm text-gray-500">User: {item.userId}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
