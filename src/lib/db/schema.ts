...
// Removed real-time monitoring, websocket, and alert tables

// Removed telemedicine and AI consultation tables

// Removed health calendar tables

// Removed health calendar Zod schemas
...
// Removed real-time monitoring type exports
...
export const doctors = pgTable('doctors', {
  ...
  avatar: text('avatar'), // URL to doctor's avatar image
  bio: text('bio'),
  isActive: boolean('is_active').default(true),
  createdAt: timestamp('created_at').defaultNow().notNull(),
  updatedAt: timestamp('updated_at').defaultNow().notNull(),
...
export const chatMessages = pgTable('chat_messages', {
  ...
  messageType: text('message_type').default('text'), // text, image, file, multimedia
...
// Message attachments table for multimedia support
export const messageAttachments = pgTable('message_attachments', {
  ...
  thumbnailUrl: text('thumbnail_url'), // URL to thumbnail for images
  uploadStatus: text('upload_status').default('completed'), // uploading, completed, failed
  analysisStatus: text('analysis_status').default('pending'), // pending, processing, completed, failed
  analysisResult: jsonb('analysis_result'), // AI analysis results for images
  isPrescription: boolean('is_prescription').default(false), // flag for prescription images
  metadata: jsonb('metadata'), // additional file metadata (dimensions, etc.)
  createdAt: timestamp('created_at').defaultNow().notNull(),
  updatedAt: timestamp('updated_at').defaultNow().notNull(),
});
...
// Removed health calendar type exports